...
pub enum OverlayConfigUpdate {
    /// Appearance config for metric overlays (+ alpha, show_empty, stack_bottom, scale, show_class_icons, font_scale, dynamic_background)
    Metric(OverlayAppearanceConfig, u8, bool, bool, f32, bool, f32, bool),
